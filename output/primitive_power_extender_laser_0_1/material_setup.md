...
- Machine: Creality Falcon A1 Pro (provisional)
- Material: Basswood, 3 mm (manufacturer_seed_unverified)
- Stock: 300.0 x 300.0 x 3.0 mm
- Effective work area: 300.0 x 268.0 mm
- Token quantity: 12
- Engraving backend: native_stroke
- Engraving font: built-in continuous-line vector font
