...
6. Inspect `preview.png`, `design.svg`, `operations.csv`, `job_plan.json`, `operations/*.gcode`, and `material_setup.md`.
7. Confirm manifests include helper ID, revision, invocation/config hash, source-output hash when applicable, operation artifact hashes, and pass counts.
